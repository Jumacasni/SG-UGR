...
class MyScene extends THREE.Scene {
  constructor (unRenderer) {
	...
	this.extrusion.applyMatrix( new THREE.Matrix4().makeRotationX(Math.PI));
	this.extrusion.scale.set(0.25,0.25,0.25);

	this.nodoB = new THREE.Mesh();
	this.nodoB.applyMatrix( new THREE.Matrix4().makeTranslation(5,0,0));
	this.nodoB.add(this.extrusion);
	
	this.nodoA = new THREE.Mesh();

    this.nodoA.add(this.nodoB);
